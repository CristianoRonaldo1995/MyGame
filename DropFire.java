 ...
 */
public class DropFire extends MouseAdapter {
     ...
     */
    public DropFire(WorldView view) {
        this.view = view;
    }
    ...
    public void mousePressed(MouseEvent e) {
        DynamicBody fire = new Fire(view.getWorld());
        fire.setPosition(view.viewToWorld(e.getPoint()));
    }
